<?php
  ...
  $oferta = $this->request->data['Oferta'];
?>
<?php if (!$canEdit): ?>
  <div class="alert alert-warning">
    <?php echo __('Esta Oferta fue publicada el %s, ya no puedes editarla.', $this->Time->d($oferta['oferta_fecini'])); ?>
  </div>
<?php endif ?>
  ...
  <div class="col-xs-12">
    <?php
      echo $this->Form->create('Oferta', array(
        ...
        // echo $this->Form->input('Oferta._defaults.passFields', array(
        //   'data-default-for' => 'data[Oferta][passFields][]',
        //   'type' => 'hidden'
        // ));
    ?>
          ...
          <div class="col-xs-6">
            <?php
              echo $this->Form->input('Oferta.estado', array(
                ...
                'value' => $this->request->data['Estado']['est_cve'],
          ...
          <div class="col-xs-6">
            <?php
              echo $this->Form->input('Oferta.ciudad_cve', array(
                ...
                'data-default-value' => $this->request->data['Oferta']['ciudad_cve'],
          ...
          <div class="col-xs-12">
            <?php
              echo $this->Form->input('Oferta.oferta_descrip', array(
                ...
                'style' => 'height: 330px; box-sizing:border-box; float:left; width:100%',
                'type' => 'textarea',
                'label' => false
              ));
            ?>
          ...
          <div class="col-xs-12">
            <?php
              echo $this->Form->input('Oferta.categorias', array(
                ...
                'placeholder' => __('Elige algunas categorías.'),
                'required' => true
              ));
            ?>
            <?php
              echo $this->Form->input('Oferta.etiquetas', array(
                ...
                'placeholder' => __('Elige algunas etiquetas.')
              ));
            ?>
          </div>
        </div>
      ...
      <?php
        echo $this->element('empresas/ofertas/actions', array(
          'status' => $new ? 0 : $oferta['status']['value'],
          'actions' => array('submit', 'preview', 'cancel'),
          'options' => array(
            'dropup' => true
          )
        ));
        ...
        $previewData = $new ? array(
          ...
          'status' => $oferta['status']['value'],
          'shortLink' => $oferta['oferta_link'],
        );

        echo $this->element('empresas/vista_previa/oferta', $previewData);
      ?>
