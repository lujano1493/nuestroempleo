      ...
      <fieldset class="modal-body">
        ...
        <div class="row">
          <div class="col-xs-8 col-md-offset-2">
            <?php
              echo $this->Form->input('UsuarioAdmin.old_password', array(
                'class' => 'form-control input-block-level',
                'label' => 'Contraseña actual',
                'type' => 'password',
                'required' => true,
              ));
              echo $this->Form->input('UsuarioAdmin.new_password', array(
                'class' => 'form-control input-block-level new_password',
                'label' => 'Ingresa tu nueva contraseña',
                'type' => 'password',
                'required' => true,
              ));
              echo $this->Form->input('UsuarioAdmin.confirm_password', array(
                'class' => 'form-control input-block-level',
