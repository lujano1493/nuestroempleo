...
<body>
  <table style="width:759px; background-color:#fff;margin:auto;">
    ...
    <tr>
      <td colspan="2" style="background-color:#666; color:#FFF; text-align:center; padding:10px;font-size:10px;">
    ...
    <tr style="background-color:#49317b; ">
      <td colspan="2" style="padding:10px; color:#FFF; text-align:left;font-size:10px">
