<table cellspacing="0" style="width:759px; background-color:#fff;" >
  <tr>
    ...
    <td style="width:50%;">
      <p style="background-color:#49317b; padding:3px; color:#FFF; font-weight:bold; font-size:16px;">Archivos de timbrado</p>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td style="width:50%; font-weight:bold; font-size:24px; color:#49317b; text-align:center;">
      <p style="color:#49317b; font-weight:bold; font-size:16px;">Archivos de timbrado</p>
    </td>
  </tr>
  <tr>
    <td colspan="2" style="background-color:#49317b; height:3px;"></td>
  ...
  <tr>
    <td colspan="2" style="text-align:center;">
      <p>
        La factura con el folio <strong><?php echo $folio ?></strong> se ha timbrado correctamente.
        Se adjuntaron los archivos del timbrado.
      </p>
      <br>
